    ...
    def create_handler(
        ...
        Args:
            ...
            **kwargs: Additional arguments for specific handlers
                     For S3: bucket, aws_access_key_id, aws_secret_access_key,
                            region (optional), endpoint_url (optional)
        ...
        if handler_type.lower() == "local":
            ...
            required_args = {"bucket", "aws_access_key_id", "aws_secret_access_key"}
