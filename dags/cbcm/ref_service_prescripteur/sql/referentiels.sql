CREATE SCHEMA donnees_comptable;

CREATE TABLE donnees_comptable."ref_service_prescripteur_pilotage" (
  "id" integer PRIMARY KEY,
  "service_prescripteur" text
);

CREATE TABLE donnees_comptable."ref_service_depense" (
  "id" integer PRIMARY KEY,
  "service_depense" text
);

CREATE TABLE donnees_comptable."ref_prog" (
  "id" integer PRIMARY KEY,
  "prog" text
);

CREATE TABLE donnees_comptable."ref_bop" (
  "id" integer PRIMARY KEY,
  "prog" int,
  "bop" text,
...
CREATE TABLE donnees_comptable."ref_cc" (
  "id" integer PRIMARY KEY,
  "prog" int,
  "bop" int,
  "uo" int,
...
CREATE TABLE donnees_comptable."ref_uo" (
  "id" integer PRIMARY KEY,
  "prog" int,
  "bop" int,
  "uo" text,
...
CREATE TABLE donnees_comptable."service_prescripteur" (
  "id" integer PRIMARY KEY,
...
CREATE TABLE donnees_comptable."ref_service_prescripteur_choisi" (
  "id" integer PRIMARY KEY,
  "service_prescripteur" text
);
